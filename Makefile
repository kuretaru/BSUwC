...
UNREALROOTPATH = /home/kuretaru/projects/project__MwUE__/UnrealEngine
GAMEPROJECTFILE =/home/kuretaru/Documents/Unreal Projects/project__BSUwC__/project__BSUwC__.uproject

TARGETS = \
	project__BSUwC__-Linux-Debug  \
	project__BSUwC__-Linux-DebugGame  \
	project__BSUwC__-Linux-Test  \
	project__BSUwC__-Linux-Shipping  \
	project__BSUwC__ \
	project__BSUwC__Editor-Linux-Debug  \
	project__BSUwC__Editor-Linux-DebugGame  \
	project__BSUwC__Editor-Linux-Test  \
	project__BSUwC__Editor-Linux-Shipping  \
	project__BSUwC__Editor \
...
project__BSUwC__-Linux-Debug:
	 $(PROJECTBUILD) project__BSUwC__ Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__-Linux-DebugGame:
	 $(PROJECTBUILD) project__BSUwC__ Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__-Linux-Test:
	 $(PROJECTBUILD) project__BSUwC__ Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__-Linux-Shipping:
	 $(PROJECTBUILD) project__BSUwC__ Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__:
	 $(PROJECTBUILD) project__BSUwC__ Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__Editor-Linux-Debug:
	 $(PROJECTBUILD) project__BSUwC__Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__Editor-Linux-DebugGame:
	 $(PROJECTBUILD) project__BSUwC__Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__Editor-Linux-Test:
	 $(PROJECTBUILD) project__BSUwC__Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__Editor-Linux-Shipping:
	 $(PROJECTBUILD) project__BSUwC__Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

project__BSUwC__Editor:
	 $(PROJECTBUILD) project__BSUwC__Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
