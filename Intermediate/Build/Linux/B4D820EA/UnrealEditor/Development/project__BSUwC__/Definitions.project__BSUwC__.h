...
#define UE_PROJECT_NAME project__BSUwC__
#define UE_TARGET_NAME project__BSUwC__Editor
#define UE_MODULE_NAME "project__BSUwC__"
...
#define PROJECT__BSUWC___API DLLEXPORT
